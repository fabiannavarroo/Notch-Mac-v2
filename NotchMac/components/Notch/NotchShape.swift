...
/// Open variant of `NotchShape` that omits the top edge so a stroked
/// border can hug the notch sides + bottom without drawing a line across
/// the top (which would visually clip the menu bar).
struct NotchOpenBorderShape: Shape {
